...
API_ID = int(environ.get('API_ID', '33247794'))
API_HASH = environ.get('API_HASH', 'b425c4d32b4c951fd85eb407c7574403')
BOT_TOKEN = environ.get('BOT_TOKEN', "8238586718:AAF6mqvQM1C0_FmIrKfXVTyk3iT_CZlzKfk")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7652646876').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6088231429').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003368198640'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003345497826').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001605587771') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002849180958')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://s84522151_db_user:7b9mhwhbEPLAxSeT@cluster0.bnf6nun.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'incognitocollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/avengersassemblex')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/incognito147')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/avengersassemblex') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/billybutcher_07')
